    ...
    <>
      ...
      {activePage !== 'settings' && (
        <nav className="bottom-nav">
          ...
          <button className={activePage === 'projects' ? 'active' : ''} onClick={() => setActivePage('projects')}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
          ...
          <button className={(activePage as string) === 'settings' ? 'active' : ''} onClick={() => setActivePage('settings' as PageKey)}>
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
            ...
            <div className="task-details-body">
              ...
              <div className="task-details-left">
                ...
                <div className="task-details-description-section">
                  <div className="description-header-toolbar">
                    ...
                    <div className="rich-text-toolbar" style={{ border: 'none', padding: 0, marginBottom: '12px' }}>
                      <div className="format-dropdown-container">
                        <button type="button" className="toolbar-btn text-format-btn" onClick={() => setShowFormatDropdown(!showFormatDropdown)}>
                          {textFormat}
                      ...
                      <button type="button" className="toolbar-btn" title="Text color">A</button>
                      <button type="button" className="toolbar-btn" title="Link">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71"></path></svg>
                      </button>
                      <button type="button" className="toolbar-btn" title="Checklist">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"></path></svg>
                      </button>
